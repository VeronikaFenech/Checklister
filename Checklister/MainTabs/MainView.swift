...
struct MainView: View {
    ...
    private var checklistArray: [ChecklistRowObject] = []
   // var checklistArray: [ChecklistRowObject] = [ChecklistRowObject(progressValue: 0.8, text: "Cleaning", taskList: "Clean kitchen, clean coﬀee, machine, do dishes", image: "Cleaning"), ChecklistRowObject(progressValue: 0.5, text: "Checklist", taskList: "Task title, task title, task title, task title", image: "DefaultChecklist")]
